...
resource "docker_container" "mongodb" {
  ...
  volumes {
    volume_name    = var.graylog_mongodb_volume_name
...
resource "docker_container" "datanode" {
  ...
  volumes {
    volume_name    = var.graylog_datanode_volume_name
...
resource "docker_container" "graylog" {
  ...
  volumes {
    volume_name    = var.graylog_data_volume_name
    container_path = "/usr/share/graylog/data/data"
  }

  volumes {
    volume_name    = var.graylog_journal_volume_name
